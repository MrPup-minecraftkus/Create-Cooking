...
public class CreateCookingClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_ICE_CREAM, ModFluids.FLOWING_ICE_CREAM,
                new SimpleFluidRenderHandler(
                        new Identifier("create_cooking:block/ice_cream"),
                        new Identifier("create_cooking:block/ice_cream")
                ));

        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_CHOCOLATE_ICE_CREAM, ModFluids.FLOWING_CHOCOLATE_ICE_CREAM,
                new SimpleFluidRenderHandler(
                        new Identifier("create_cooking:block/chocolate_ice_cream"),
                        new Identifier("create_cooking:block/chocolate_ice_cream")
                ));

        FluidRenderHandlerRegistry.INSTANCE.register(ModFluids.STILL_WATERMELON_ICE_CREAM, ModFluids.FLOWING_WATERMELON_ICE_CREAM,
                new SimpleFluidRenderHandler(
                        new Identifier("create_cooking:block/watermelon_ice_cream"),
                        new Identifier("create_cooking:block/watermelon_ice_cream")
                ));
        ...
        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(),
                ModFluids.STILL_ICE_CREAM, ModFluids.FLOWING_ICE_CREAM);

        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(),
                ModFluids.STILL_CHOCOLATE_ICE_CREAM, ModFluids.FLOWING_CHOCOLATE_ICE_CREAM);

        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(),
                ModFluids.STILL_WATERMELON_ICE_CREAM, ModFluids.FLOWING_WATERMELON_ICE_CREAM);
    }
}
